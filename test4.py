...
def simulate_overtime(team1, team2, initial_team1_wins, initial_team2_wins, overtime_rounds=6):
    while True:
        ...
        if team1_ot_wins > team2_ot_wins:
            ...
            return team2, initial_team1_wins + team1_ot_wins, initial_team2_wins + team1_ot_wins
        else:
...
team1 = Team("Команда А", [Player("Игрок 1", 0.9), Player("Игрок 2", 0.8), Player("Игрок 3", 0.85), Player("Игрок 4", 0.87), Player("Игрок 5", 0.88)])
team2 = Team("Команда Б", [Player("Игрок 6", 0.86), Player("Игрок 7", 0.84), Player("Игрок 8", 0.83), Player("Игрок 9", 0.9), Player("Игрок 10", 0.87)])
